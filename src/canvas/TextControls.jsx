...
const TextControls = () => {
  ...
  return (
    <div className="absolute bg-white p-6 left-full ml-3 flex flex-col space-y-2 overflow-y-scroll w-65 h-80">
      ...
      <div className="flex grid grid-row-2 text-sm gap-y-3 grid-cols-2">
        <div className="flex items-center space-x-2">
